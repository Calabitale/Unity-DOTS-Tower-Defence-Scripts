...
public class AnimationConverter : MonoBehaviour
{
    ...
    //            try
    //            {
    //                AssetDatabase.CreateAsset(staticmesh, SaveLocation + AmountSavedSoFar.ToString() + animation.clip.name + "_StaticFromSkinned" + ".asset");//TODO This code creates an Build error
    //            }
