...
public partial class FlowFieldAddLayerSystem : SystemBase
{
    ...
    {      
        ...
        var execute66 = HasSingleton<AddLayerSystemEvent>() ? GetSingletonEntity<AddLayerSystemEvent>() : Entity.Null ; 
...
public partial class FlowFieldRemoveLayerSystem : SystemBase //TODO Will I ever want to remove a layer and how exactly and where from will I want to remove a layer, it would surely have to be at a specific index for a specific bunch of entities
{
    public EntityQuery DestinationQuery;
