...
{
    public partial class CalculateCellCostSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var TheObstacleents = TerrainObsQuery.ToEntityArray(Allocator.Temp);                
                
            EntityManager.AddComponent<Disabled>(TheObstacleents);   
    ...
    public struct GetNeighborIndices
    {
        ...
        public FixedList128Bytes<int2> Execute(int2 originIndex, int2 gridSize, bool WhatDirections, ref FixedList128Bytes<int2> results)
        {
